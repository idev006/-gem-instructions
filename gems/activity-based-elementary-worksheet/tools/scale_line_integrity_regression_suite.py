...
add('builder-runs-scale-suite','scale_line_integrity_regression_suite.py' in builder and '1300/1300 PASS' in builder)
add('workflow-runs-scale-suite','Scale-line integrity regression' in workflow and '40 cases' in workflow)
add('validator-release-1300','scale_line_integrity_regression_suite.py' in validator and '1300' in validator and '1300/1300 PASS' in checklist)
