...
Additive clock half-hour formula hardening: +96 cases.
Additive weight-dial visible subdivision hardening: +32 cases.
Additive primary-school pedagogy/usability hardening: +64 cases.
Effective established regression gate: 1494/1494 PASS plus clock half-hour formula gate 96/96 PASS plus P3 one-page gate 100/100 PASS.
...
ALL_SKILLS_RUNTIME_PROFILE = 'policies/ALL_SKILLS_RUNTIME_INVARIANT_PROFILE.md'
...
CLOCK_MINUTE_DRIVER_PROFILE = 'policies/CLOCK_MINUTE_HAND_DRIVEN_HOUR_HAND_POLICY.md'
CLOCK_P3_ONE_PAGE_PROFILE = 'policies/THAI_P3_CLOCK_HALF_HOUR_ONE_PAGE_PROFILE.md'
SCALE_TICK_PROFILE = 'policies/SCALE_TICK_STANDARD.md'
TICK_HIERARCHY_PROFILE = 'policies/INSTRUMENT_TICK_HIERARCHY_POLICY.md'
PROTRACTOR_MANIFEST_PROFILE = 'policies/PROTRACTOR_181_TICK_MANIFEST_PROFILE.md'
...
WORKER_BUNDLES = {
    ...
    'W02_TIME_CLOCK.txt': ['workers/W02_TIME_CLOCK.md', 'domains/TIME_ENGINE.md', 'domains/CLOCK_READING_ENGINE.md', 'domains/CLOCK_DAY_NIGHT_SINGLE_FACE_SPEC.md', THAI_CLOCK_RUNTIME_PROFILE, CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md', 'skill-metrics/TIME_CALCULATION_SKILL_METRICS.md', 'skill-metrics/ANALOG_CLOCK_SKILL_METRICS.md'],
    ...
    'W07_INSTRUMENT_AUDITOR.txt': ['workers/W07_INSTRUMENT_AUDITOR.md', 'domains/INSTRUMENT_READING_ENGINE.md', WEIGHT_VISIBLE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md', PROTRACTOR_MANIFEST_PROFILE, 'qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md'],
    'W08_LAYOUT_RENDER_THAI.txt': ['workers/W08_LAYOUT_RENDER_THAI.md', WEIGHT_VISIBLE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md', PROTRACTOR_MANIFEST_PROFILE, 'qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md'],
    'W09_QA_RELEASE.txt': ['workers/W09_QA_RELEASE.md', 'OUTPUT_CONTRACT.md', 'ARCHITECTURE.md', 'KB_ROUTER.md', 'KB_MANIFEST.md', 'policies/PARAMETER_POLICY.md', THAI_CLOCK_RUNTIME_PROFILE, WEIGHT_VISIBLE_PROFILE, 'domains/DOMAIN_REGISTRY.md', 'domains/MEASUREMENT_COVERAGE_P1_P6.md', 'qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md', 'qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md', 'qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md', 'qa/ACTUAL_INSTRUMENT_GEOMETRY_DEFECTS_2026_08_31.md', 'qa/ACTUAL_MEASUREMENT_REFERENCE_DEFECTS_2026_08_31.md', 'qa/ACTUAL_CLOCK_HAND_ENDPOINT_REGRESSION_2026_09_01.md', 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', 'qa/ACTUAL_WEIGHT_DIAL_VISIBLE_SUBDIVISION_REGRESSION_2026_09_01.md', 'qa/FULL_CLEAN_ROOM_PEDAGOGY_AUDIT_2026_09_02.md', 'qa/CAPABILITY_QUALITY_ITERATION_REPORT_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md', PROTRACTOR_MANIFEST_PROFILE, 'qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md'],
    'W10_METROLOGY_ENGINEER.txt': ['workers/W10_METROLOGY_ENGINEER.md', 'domains/INSTRUMENT_READING_ENGINE.md', WEIGHT_VISIBLE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md', PROTRACTOR_MANIFEST_PROFILE, 'qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md'],
}
...
def bundle_text(name: str, sources: list[str]) -> str:
    effective = [*SHARED_PROFILES, PEDAGOGY_PROFILE, CAPABILITY_PROFILE, ALL_SKILLS_RUNTIME_PROFILE, *sources]
...
def main() -> int:
    gates = [
        ...
        ('protractor_181_tick_manifest_regression_suite.py', '220-case protractor 181-tick manifest regression'),
        ...
        ('clock_half_hour_formula_regression_suite.py', '96-case clock half-hour formula regression'),
        ('clock_p3_half_hour_one_page_regression_suite.py', '100-case clock P3 half-hour one-page regression'),
        ...
        ('all_skills_clean_room_audit_suite.py', '180-case all-skills clean-room audit'),
    ...
    main_sections = [
        'COMPACT RUNTIME PROFILE\nEstablished baseline 1366/1366 PASS + clock endpoint 32 + clock half-hour formula 96 + P3 one-page 100 + weight visible subdivision 32 + primary-school pedagogy 64; established 1494/1494 PASS plus 96/96 clock formula gate. Skill metric 161/161 PASS. Scale tick standard 120/120 PASS. Exactly 10 base worker Knowledge files.\n\n',
        ...
        '\n\n===== MANDATORY ALL-SKILLS RUNTIME INVARIANT =====\n\n' + read(ALL_SKILLS_RUNTIME_PROFILE),
        ...
        '\n\n===== CLOCK MINUTE-HAND-DRIVEN HOUR-HAND POLICY =====\n\n' + read(CLOCK_MINUTE_DRIVER_PROFILE) + '\n\n===== CLOCK P3 HALF-HOUR ONE-PAGE PROFILE =====\n\n' + read(CLOCK_P3_ONE_PAGE_PROFILE) + '\n\n===== CLOCK HALF-HOUR FORMULA DEFECT EVIDENCE =====\n\n' + read('qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md'),
        '\n\n===== CLOCK HALF-HOUR ONE-PAGE ARTIFACT DEFECT =====\n\n' + read('qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md'),
        ...
        '\n\n===== PROTRACTOR 181-POSITION MANIFEST PROFILE =====\n\n' + read(PROTRACTOR_MANIFEST_PROFILE),
        '\n\n===== ACTUAL PROTRACTOR MISSING-TICK / LABEL DEFECT =====\n\n' + read('qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md'),
    ...
    for rel in ['qa/CLASSROOM_ARTIFACT_QUALIFICATION_UAT.md','qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md','qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','qa/ACTUAL_INSTRUMENT_GEOMETRY_DEFECTS_2026_08_31.md','qa/ACTUAL_MEASUREMENT_REFERENCE_DEFECTS_2026_08_31.md','qa/ACTUAL_CLOCK_HAND_ENDPOINT_REGRESSION_2026_09_01.md','qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_WEIGHT_DIAL_VISIBLE_SUBDIVISION_REGRESSION_2026_09_01.md','qa/FULL_CLEAN_ROOM_PEDAGOGY_AUDIT_2026_09_02.md','qa/CAPABILITY_QUALITY_ITERATION_REPORT_2026_09_05.md','qa/FULL_GEM_ALL_SKILLS_CLEAN_ROOM_AUDIT_2026_09_05.md','qa/INSTRUMENT_SCALE_DEFECT_TAXONOMY.md','qa/EXTERNAL_INSTRUMENT_SCALE_REFERENCE_REVIEW_2026_09_05.md','qa/ACTUAL_PROTRACTOR_MISSING_TICK_LABEL_REGRESSION_2026_09_05.md']:
        docs[rel.replace('/','_').replace('.md','.txt')] = read(rel)
    for rel in [WEIGHT_VISIBLE_PROFILE, PEDAGOGY_PROFILE, CAPABILITY_PROFILE, ALL_SKILLS_RUNTIME_PROFILE, SCALE_TICK_PROFILE, TICK_HIERARCHY_PROFILE, PROTRACTOR_MANIFEST_PROFILE, CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE]: docs[rel.replace('/','_').replace('.md','.txt')] = read(rel)
    ...
    report_names = ['SSOT_VALIDATION_REPORT.txt','FULL_DRY_RUN_449_REPORT.txt','FULL_SKILL_MATRIX_360_REPORT.txt','RUNTIME_UAT_REGRESSION_12_REPORT.txt','SEMANTIC_ORACLE_REGRESSION_20_REPORT.txt','SYSTEM_WIDE_QUALITY_REGRESSION_30_REPORT.txt','SCALE_LINE_INTEGRITY_REGRESSION_40_REPORT.txt','INSTRUMENT_REVIEW_SPEEDOMETER_REGRESSION_60_REPORT.txt','PROTRACTOR_SCALE_SAFETY_REGRESSION_24_REPORT.txt','PROTRACTOR_181_TICK_MANIFEST_REGRESSION_220_REPORT.txt','METROLOGY_FULL_AUDIT_REGRESSION_80_REPORT.txt','WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_32_REPORT.txt','PHYSICAL_PAGE_FEASIBILITY_REGRESSION_48_REPORT.txt','ACTUAL_INSTRUMENT_GEOMETRY_REGRESSION_64_REPORT.txt','MEASUREMENT_REFERENCE_ARTIFACT_REGRESSION_66_REPORT.txt','CLOCK_HAND_ENDPOINT_REGRESSION_32_REPORT.txt','CLOCK_HALF_HOUR_FORMULA_REGRESSION_96_REPORT.txt','CLOCK_P3_HALF_HOUR_ONE_PAGE_REGRESSION_100_REPORT.txt','WEIGHT_DIAL_VISIBLE_SUBDIVISION_REGRESSION_32_REPORT.txt','PRIMARY_SCHOOL_PEDAGOGY_REGRESSION_64_REPORT.txt','REPOSITORY_FULL_LINE_AUDIT_81_REPORT.txt','SKILL_METRIC_PACK_REGRESSION_161_REPORT.txt','SCALE_TICK_STANDARD_REGRESSION_120_REPORT.txt','ALL_SKILLS_CLEAN_ROOM_AUDIT_180_REPORT.txt','CAPABILITY_QUALITY_SCORECARD_300_CRITERIA_REPORT.txt']
    ...
    print('CLOCK HALF-HOUR FORMULA HARDENING: 96/96 PASS')
    print('WEIGHT DIAL VISIBLE SUBDIVISION HARDENING: 32/32 PASS')
    print('PRIMARY-SCHOOL PEDAGOGY/USABILITY HARDENING: 64/64 PASS')
    print('EFFECTIVE ESTABLISHED REGRESSION GATE: 1494/1494 PASS plus CLOCK HALF-HOUR FORMULA 96/96 PASS plus CLOCK P3 ONE-PAGE 100/100 PASS')
    ...
    print('PROTRACTOR 181-TICK MANIFEST HARDENING: 220/220 PASS')
    print('ALL-SKILLS CLEAN-ROOM AUDIT: 180/180 PASS')
    ...
    print('All-skills runtime invariant: INCLUDED in every worker bundle and main instructions')
    ...
    print('Protractor 181-position manifest profile + actual defect regression: INCLUDED')
    print('Clock half-hour formula artifact regression: INCLUDED')
    print('Clock minute-hand driver policy: INCLUDED')
    print('Clock P3 half-hour one-page profile + artifact regression: INCLUDED')
