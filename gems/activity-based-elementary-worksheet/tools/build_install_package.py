...
WORKER_BUNDLES = {
    ...
    'W07_INSTRUMENT_AUDITOR.txt': ['workers/W07_INSTRUMENT_AUDITOR.md', 'domains/INSTRUMENT_READING_ENGINE.md', WEIGHT_VISIBLE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md'],
    'W08_LAYOUT_RENDER_THAI.txt': ['workers/W08_LAYOUT_RENDER_THAI.md', WEIGHT_VISIBLE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md', CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE, 'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md'],
...
def main() -> int:
    ...
    main_sections = [
        'COMPACT RUNTIME PROFILE\nEstablished baseline 1366/1366 PASS + clock endpoint 32 + clock half-hour formula 96 + P3 one-page 100 + weight visible subdivision 32 + primary-school pedagogy 64; established 1494/1494 PASS plus 72/72 clock formula gate. Skill metric 161/161 PASS. Scale tick standard 120/120 PASS. Exactly 10 base worker Knowledge files.\n\n',
    ...
    for rel in ['qa/CLASSROOM_ARTIFACT_QUALIFICATION_UAT.md','qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md','qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','qa/ACTUAL_INSTRUMENT_GEOMETRY_DEFECTS_2026_08_31.md','qa/ACTUAL_MEASUREMENT_REFERENCE_DEFECTS_2026_08_31.md','qa/ACTUAL_CLOCK_HAND_ENDPOINT_REGRESSION_2026_09_01.md','qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_WEIGHT_DIAL_VISIBLE_SUBDIVISION_REGRESSION_2026_09_01.md','qa/FULL_CLEAN_ROOM_PEDAGOGY_AUDIT_2026_09_02.md','qa/CAPABILITY_QUALITY_ITERATION_REPORT_2026_09_05.md','qa/FULL_GEM_ALL_SKILLS_CLEAN_ROOM_AUDIT_2026_09_05.md','qa/INSTRUMENT_SCALE_DEFECT_TAXONOMY.md','qa/EXTERNAL_INSTRUMENT_SCALE_REFERENCE_REVIEW_2026_09_05.md']:
        docs[rel.replace('/','_').replace('.md','.txt')] = read(rel)
    for rel in [WEIGHT_VISIBLE_PROFILE, PEDAGOGY_PROFILE, CAPABILITY_PROFILE, ALL_SKILLS_RUNTIME_PROFILE, SCALE_TICK_PROFILE, TICK_HIERARCHY_PROFILE, CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE]: docs[rel.replace('/','_').replace('.md','.txt')] = read(rel)
