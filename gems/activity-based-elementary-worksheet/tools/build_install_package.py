...
def main() -> int:
    ...
    for rel in [WEIGHT_VISIBLE_PROFILE, PEDAGOGY_PROFILE, CAPABILITY_PROFILE, SCALE_TICK_PROFILE, TICK_HIERARCHY_PROFILE, CLOCK_MINUTE_DRIVER_PROFILE, CLOCK_P3_ONE_PAGE_PROFILE]: docs[rel.replace('/','_').replace('.md','.txt')] = read(rel)
