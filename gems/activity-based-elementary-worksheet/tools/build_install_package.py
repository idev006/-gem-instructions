...
64 actual-instrument-geometry + 81 repository-full-line = 1300 cases.
"""
...
def main():
    ...
    compact='COMPACT RUNTIME PROFILE\nBuilt only after 1300/1300 PASS. Exactly 10 base worker Knowledge files.\nMandatory shared profiles: 5\n\n'
    ...
    print('COMBINED DRY-RUN: 1300/1300 PASS')
