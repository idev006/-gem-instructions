...
('builder-shared-profile-workers','SHARED_PROFILES' in builder and 'effective=[*SHARED_PROFILES,PEDAGOGY_PROFILE,CAPABILITY_PROFILE,ALL_SKILLS_RUNTIME_PROFILE,*sources]' in compact),
