...
SUITES=[('tools/full_dry_run_suite.py','449'),('tools/full_skill_matrix_suite.py','360'),('tools/runtime_uat_regression_suite.py','12'),('tools/semantic_oracle_regression_suite.py','20'),('tools/system_wide_quality_regression_suite.py','30'),('tools/scale_line_integrity_regression_suite.py','40'),('tools/instrument_review_speedometer_regression_suite.py','60'),('tools/protractor_scale_safety_regression_suite.py','24'),('tools/metrology_full_audit_regression_suite.py','80'),('tools/weight_dial_inactive_gap_regression_suite.py','32'),('tools/physical_page_feasibility_regression_suite.py','48'),('tools/instrument_geometry_artifact_regression_suite.py','64'),('tools/repository_full_line_audit_suite.py','81')]
REQUIRED_FILES=['GEM_INSTRUCTIONS_PRODUCTION.md','OUTPUT_CONTRACT.md','ARCHITECTURE.md','KB_ROUTER.md','KB_MANIFEST.md','README.md','USER_GUIDE.md','GEM_INSTALLATION_GUIDE.md','policies/PARAMETER_POLICY.md','policies/THAI_P3_CLOCK_RUNTIME_PROFILE.md','policies/SYSTEM_WIDE_QUALITY_PROFILE.md','policies/SCALE_LINE_INTEGRITY_PROFILE.md','policies/INSTRUMENT_REVIEW_REVISE_PROFILE.md','policies/METROLOGY_ASSURANCE_PROFILE.md','policies/PHYSICAL_PAGE_FEASIBILITY_PROFILE.md','domains/DOMAIN_REGISTRY.md','domains/MEASUREMENT_COVERAGE_P1_P6.md','domains/INSTRUMENT_READING_ENGINE.md','domains/CLOCK_READING_ENGINE.md','domains/SCALE_READING_ENGINE.md','domains/LENGTH_READING_ENGINE.md','domains/SPEEDOMETER_READING_ENGINE.md','domains/TEMPERATURE_READING_ENGINE.md','domains/CAPACITY_READING_ENGINE.md','domains/TABLE_GRAPH_READING_ENGINE.md','qa/ACTUAL_RULER_EXTRA_TICK_REGRESSION_2026_08_31.md','qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md','qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','qa/ACTUAL_INSTRUMENT_GEOMETRY_DEFECTS_2026_08_31.md','qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md','qa/DOMAIN_RELEASE_MATRIX.md','tools/build_install_package.py',*[x[0] for x in SUITES],*WORKERS.values()]
...
def main():
    ...
    need(errors,'workers/W04_LENGTH_DISTANCE.md','perfect, undistorted upper semicircle','ARC_CENTER == BASELINE_MIDPOINT == RAY_ORIGIN == PROTRACTOR_CENTER','one active numeric scale only by default','PROTRACTOR_BODY_HEIGHT_MM = PROTRACTOR_BODY_WIDTH_MM/2')
    ...
    if errors:
        print(f'SSOT VALIDATION: FAIL ({len(errors)} issue(s))');[print('FAIL',e) for e in errors];return 1
    print('SSOT VALIDATION: PASS');print('release family: 2.6.3-LTS / compatible baseline 2.6.x');print('workers: 10/10 unique, schema=1');print('mandatory runtime profiles: 5');print('actual instrument geometry regression: 64-case executable present');print('repository full-line audit: 81-case executable present');print('combined minimum release gate: 1300 cases');print('artifact QA: NOT_YET_TESTED');return 0
