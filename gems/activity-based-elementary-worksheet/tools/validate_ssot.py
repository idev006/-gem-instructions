...
SUITES=[('tools/full_dry_run_suite.py','449'),('tools/full_skill_matrix_suite.py','360'),('tools/runtime_uat_regression_suite.py','12'),('tools/semantic_oracle_regression_suite.py','20'),('tools/system_wide_quality_regression_suite.py','30'),('tools/scale_line_integrity_regression_suite.py','40'),('tools/instrument_review_speedometer_regression_suite.py','60'),('tools/protractor_scale_safety_regression_suite.py','24'),('tools/metrology_full_audit_regression_suite.py','80'),('tools/weight_dial_inactive_gap_regression_suite.py','32'),('tools/physical_page_feasibility_regression_suite.py','48'),('tools/instrument_geometry_artifact_regression_suite.py','64'),('tools/measurement_reference_artifact_regression_suite.py','66'),('tools/clock_hand_endpoint_regression_suite.py','32'),('tools/clock_half_hour_formula_regression_suite.py','96'),('tools/clock_p3_half_hour_one_page_regression_suite.py','100'),('tools/weight_dial_visible_subdivision_regression_suite.py','32'),('tools/primary_school_pedagogy_regression_suite.py','64'),('tools/repository_full_line_audit_suite.py','81')]
REQUIRED_FILES=['GEM_INSTRUCTIONS_PRODUCTION.md','OUTPUT_CONTRACT.md','ARCHITECTURE.md','KB_ROUTER.md','KB_MANIFEST.md','README.md','USER_GUIDE.md','GEM_INSTALLATION_GUIDE.md','policies/PARAMETER_POLICY.md','policies/THAI_P3_CLOCK_RUNTIME_PROFILE.md','policies/CLOCK_MINUTE_HAND_DRIVEN_HOUR_HAND_POLICY.md','policies/THAI_P3_CLOCK_HALF_HOUR_ONE_PAGE_PROFILE.md','policies/SYSTEM_WIDE_QUALITY_PROFILE.md','policies/SCALE_LINE_INTEGRITY_PROFILE.md','policies/INSTRUMENT_REVIEW_REVISE_PROFILE.md','policies/METROLOGY_ASSURANCE_PROFILE.md','policies/PHYSICAL_PAGE_FEASIBILITY_PROFILE.md','policies/PRIMARY_SCHOOL_WORKSHEET_PEDAGOGY_PROFILE.md','policies/CAPABILITY_QUALITY_GATE.md','policies/ALL_SKILLS_RUNTIME_INVARIANT_PROFILE.md','policies/WEIGHT_DIAL_VISIBLE_TICK_SET_PROFILE.md','domains/DOMAIN_REGISTRY.md','domains/MEASUREMENT_COVERAGE_P1_P6.md','domains/INSTRUMENT_READING_ENGINE.md','domains/CLOCK_READING_ENGINE.md','domains/SCALE_READING_ENGINE.md','domains/LENGTH_READING_ENGINE.md','domains/SPEEDOMETER_READING_ENGINE.md','domains/TEMPERATURE_READING_ENGINE.md','domains/CAPACITY_READING_ENGINE.md','domains/TABLE_GRAPH_READING_ENGINE.md','qa/ACTUAL_RULER_EXTRA_TICK_REGRESSION_2026_08_31.md','qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md','qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','qa/ACTUAL_INSTRUMENT_GEOMETRY_DEFECTS_2026_08_31.md','qa/ACTUAL_MEASUREMENT_REFERENCE_DEFECTS_2026_08_31.md','qa/ACTUAL_CLOCK_HAND_ENDPOINT_REGRESSION_2026_09_01.md','qa/ACTUAL_CLOCK_HALF_HOUR_FORMULA_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md','qa/ACTUAL_WEIGHT_DIAL_VISIBLE_SUBDIVISION_REGRESSION_2026_09_01.md','qa/FULL_CLEAN_ROOM_PEDAGOGY_AUDIT_2026_09_02.md','qa/CAPABILITY_QUALITY_ITERATION_REPORT_2026_09_05.md','qa/FULL_GEM_ALL_SKILLS_CLEAN_ROOM_AUDIT_2026_09_05.md','qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md','qa/DOMAIN_RELEASE_MATRIX.md','tools/build_install_package.py','tools/all_skills_clean_room_audit_suite.py','tools/capability_quality_scorecard.py',*[x[0] for x in SUITES],*WORKERS.values()]
...
def main():
    ...
    need(errors,'policies/ALL_SKILLS_RUNTIME_INVARIANT_PROFILE.md','CANONICAL_STATE -> INDEPENDENT_VERIFY -> STUDENT_VIEW_DERIVATION -> LAYOUT -> RELEASE','OWNER -> W07 -> W10 -> W08 -> W09','Default page is A4 Portrait')
    ...
    need(errors,'workers/W02_TIME_CLOCK.md','PROMPT_CLOCK_QUARTER_HOUR_INTERPOLATION_QA','14:45 / 2:45','82.5°','MINUTE_HAND_DRIVES_HOUR_HAND_POSITION=YES','hour_displacement = minute_angle / 12','PROMPT_CLOCK_MINUTE_HAND_DRIVER_QA')
    need(errors,'domains/CLOCK_READING_ENGINE.md','minute_hand_angle_deg / 12','CLOCK_MINUTE_HAND_DRIVER_QA')
    need(errors,'policies/CLOCK_MINUTE_HAND_DRIVEN_HOUR_HAND_POLICY.md','MINUTE_HAND_DRIVES_HOUR_HAND_POSITION=YES','hour_hand_displacement_deg = minute_hand_angle_deg / 12')
    need(errors,'policies/THAI_P3_CLOCK_HALF_HOUR_ONE_PAGE_PROFILE.md','FEASIBILITY_CONFIRMED_ONE_PAGE_LAYOUT_REQUIRED=YES','GRID_COLUMNS=2','GRID_ROWS=5','REQUIRED_GRID_WIDTH_MM=2×91+4=186 <=194','REQUIRED_GRID_HEIGHT_MM=5×43+4×4=231 <=243')
    ...
    need(errors,'workers/W08_LAYOUT_RENDER_THAI.md','THAI_P3_CLOCK_HALF_HOUR_ONE_PAGE_PROFILE','PROMPT_CLOCK_P3_HALF_HOUR_10_ITEM_ONE_PAGE_QA','PROTRACTOR_BODY_HEIGHT_MM=35','shape-aware','2-column layout is preferred','Never emit `OUTPUT_MODE=DETERMINISTIC_VECTOR`','START_PROJECTION_GUIDE_X','INTERVALS_PER_100ML=2','HALF_KG_INTERMEDIATE_OFFSET=0.5')
    ...
    need(errors,'workers/W09_QA_RELEASE.md','PROMPT_CLOCK_MINUTE_HAND_DRIVER_QA','PROMPT_CLOCK_P3_HALF_HOUR_10_ITEM_ONE_PAGE_QA','PROMPT_SPEEDOMETER_PIVOT_CENTER_QA','PROMPT_DIAL_LABEL_ORDER_QA','PROMPT_THERMOMETER_HIERARCHY_COUNT_QA','PROMPT_PROTRACTOR_SHAPE_INTEGRITY_QA','PROMPT_CLOCK_QUARTER_HOUR_INTERPOLATION_QA','PROMPT_RULER_ENDPOINT_PROJECTION_GUIDE_QA','PROMPT_WEIGHT_HALF_KG_INTERMEDIATE_QA','PROMPT_CAPACITY_LOCAL_SPAN_RECOUNT_QA')
    ...
    need(errors,'qa/ACTUAL_CLOCK_HALF_HOUR_ONE_PAGE_ARTIFACT_REGRESSION_2026_09_05.md','ARTIFACT_PAGE_COUNT_QA=FAIL','CLASSROOM_RELEASE=BLOCKED','3:30 / 15:30')
    ...
    need(errors,'qa/FULL_GEM_ALL_SKILLS_CLEAN_ROOM_AUDIT_2026_09_05.md','F1 — Registry version drift','F5 — Skill metric packs lacked a uniform runtime-state declaration','ARTIFACT_QA=NOT_YET_TESTED')
    ...
    for token in ['Full metrology audit — 80 cases','Actual weight-dial inactive-gap regression — 32 cases','Physical page feasibility regression — 48 cases','Actual instrument geometry regression — 64 cases','Measurement reference artifact regression — 66 cases','Clock hand endpoint regression — 32 cases','Clock half-hour formula regression — 96 cases','Clock P3 half-hour one-page regression — 100 cases','Weight dial visible subdivision regression — 32 cases','Primary-school pedagogy regression — 64 cases','Repository full-line audit — 81 semantic cases','clock_hand_endpoint_regression_suite.py','weight_dial_visible_subdivision_regression_suite.py','primary_school_pedagogy_regression_suite.py','repository_full_line_audit_suite.py','Skill metric pack governance — 161 cases','skill_metric_pack_regression_suite.py','All-skills clean-room audit — 180 cases','all_skills_clean_room_audit_suite.py','Capability quality scorecard — every capability >=95%','capability_quality_scorecard.py','v2.6.3_LTS_10WORKERS_TXT']:
