...
Prompt/package coherence only. The additive release gate is 1155 cases.
...
'qa/ACTUAL_RULER_EXTRA_TICK_REGRESSION_2026_08_31.md','qa/ACTUAL_WEIGHT_DIAL_INACTIVE_GAP_REGRESSION_2026_08_31.md','qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md','qa/DOMAIN_RELEASE_MATRIX.md',
...
'tools/protractor_scale_safety_regression_suite.py','tools/metrology_full_audit_regression_suite.py','tools/weight_dial_inactive_gap_regression_suite.py','tools/physical_page_feasibility_regression_suite.py','tools/build_install_package.py',*WORKERS.values()]
...
def main():
    ...
    need(errors,'policies/METROLOGY_ASSURANCE_PROFILE.md','ONE WRONG INSTRUCTIONAL SCALE = RELEASE BLOCKER','PHYSICAL_PAGE_FEASIBILITY_PROFILE.md','METROLOGY_MINIMUM_SIZE_MM','PROMPT_PHYSICAL_PAGE_STATE_QA','ARTIFACT_QA=NOT_YET_TESTED')
    need(errors,'policies/PHYSICAL_PAGE_FEASIBILITY_PROFILE.md','NO NUMERIC PACKING PROOF = NO PAGE-FEASIBILITY PASS','ONE_PAGE_PREFERRED != ONE_PAGE_LOCKED','REQUIRED_GRID_HEIGHT_MM','PROMPT_OUTPUT_MODE_QA','PROMPT_NUMERIC_INEQUALITY_CONSISTENCY_QA')
    ...
    need(errors,'tools/physical_page_feasibility_regression_suite.py','Expected case count: exactly 48','assert len(CASES)==48','page packing + pagination + field semantics')
    need(errors,'qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md','W10_METROLOGY_ENGINEER','1155/1155 PASS','ONE WRONG INSTRUCTIONAL SCALE = RELEASE BLOCKER','physical page feasibility')
    ...
    need(errors,'qa/CONSOLIDATED_PHYSICAL_PAGE_FEASIBILITY_REGRESSION_2026_08_31.md','NO NUMERIC PACKING PROOF = NO PAGE-FEASIBILITY PASS','Speedometer clarification — NOT A DEFECT','PROMPT_PAGE_POLICY_SERIALIZATION_QA')

    builder=read('tools/build_install_package.py')
    for profile in ['policies/SYSTEM_WIDE_QUALITY_PROFILE.md','policies/SCALE_LINE_INTEGRITY_PROFILE.md','policies/INSTRUMENT_REVIEW_REVISE_PROFILE.md','policies/METROLOGY_ASSURANCE_PROFILE.md','policies/PHYSICAL_PAGE_FEASIBILITY_PROFILE.md']:
    ...
    for token in ['Full metrology audit — 80 cases','metrology_full_audit_regression_suite.py','Actual weight-dial inactive-gap regression — 32 cases','weight_dial_inactive_gap_regression_suite.py','Physical page feasibility regression — 48 cases','physical_page_feasibility_regression_suite.py','v2.6.3_LTS_10WORKERS_TXT']:
    ...
    print('mandatory runtime profiles: system-wide + scale-line + instrument review-revise + metrology assurance + physical page feasibility')
    ...
    print('physical page feasibility regression: 48-case executable present')
    print('combined minimum release gate: 1155 cases')
