...
Prompt/package coherence only. Additive release gate: 1366 cases.
...
def main():
    ...
    need(errors,'workers/W03_WEIGHT_SCALE.md','PROMPT_WEIGHT_PER_KG_SUBDIVISION_QA','PROMPT_WEIGHT_HALF_KG_INTERMEDIATE_QA')
    ...
    need(errors,'qa/BASELINE_2_6_3_RELEASE_CHECKLIST.md','1366/1366 PASS','actual instrument geometry regression: 64','measurement reference artifact regression: 66','repository full-line audit: 81')
    builder=read('tools/build_install_package.py')
    for token in ['activity-based-elementary-worksheet_Gem_v2.6.3_LTS_10WORKERS_TXT','W10_METROLOGY_ENGINEER.txt','PHYSICAL_PAGE_FEASIBILITY_PROFILE.md','instrument_geometry_artifact_regression_suite.py','measurement_reference_artifact_regression_suite.py','repository_full_line_audit_suite.py','1366/1366 PASS','Knowledge bundle count must equal 10','Mandatory shared profiles: 5','ACTUAL_MEASUREMENT_REFERENCE_DEFECTS_2026_08_31.md']:
