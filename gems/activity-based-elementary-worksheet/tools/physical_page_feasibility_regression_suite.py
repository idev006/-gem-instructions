...
Protects W10→W08→W09 packing, pagination, size-oracle and field-semantics contracts.
"""
...
add('protractor-5x70-impossible',5*70>297)
add('protractor-required-height',5*70==350)
...
# 17-24 page-policy / semantic oracles
...
add('speed-expanded-equivalent',(380%360)==20)
add('protractor-minimum-genuine',70>=68.7549354)

# 25-40 policy/worker integration tokens
...
('w08-numeric-state','PHYSICAL_PAGE_STATE' in w08),
...
('w10-weight-impossible','five rows of 80 mm dials require at least 400 mm' in w10),
('w10-protractor-impossible','five rows of 70 mm protractors require at least 350 mm' in w10),
...
# 41-48 package/release integration tokens
...
('checklist-physical','physical page feasibility' in checklist.lower()),
]: add(n,o)
